	...
	<body>
            	 ...
            	 <tr align="center">
            		<td colspan="5">
            			...
            			<c:if test="${pi.currentPage ne 1 }">
                    		<a href="/notice/search.kh?page=${pi.currentPage - 1 }&searchCondition=${search.searchCondition}&searchValue=${search.searchValue}">&laquo;</a>
                    	</c:if>
                       ...
                       <c:if test="${pi.currentPage ne pi.maxPage }">
                    		<a href="/notice/search.kh?page=${pi.currentPage + 1 }&searchCondition=${search.searchCondition}&searchValue=${search.searchValue}">&raquo;</a>
                    	</c:if>
            		</td>
            	</tr> 
                <%-- <tr>
        ...
        <form action="/notice/search.kh" method="get" class="form-inline my-2 my-lg-0">
	        <select name="searchCondition">
		        ...
		        <input type="search" id="search" name="searchValue" value="${search.searchValue }" class="form-control mr-sm-2" placeholder="검색어를 입력해주세요" aria-label="Search">
